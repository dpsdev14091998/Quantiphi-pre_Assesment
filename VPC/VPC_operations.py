...
ec2_client.create_tags(Resources=subnet_1_public_tag,Tags=[{'Key':'Name','Value':'public_subnet_1'}])
ec2_client.create_tags(Resources=subnet_2_public_tag,Tags=[{'Key':'Name','Value':'public_subnet_2'}])
ec2_client.create_tags(Resources=subnet_3_private_tag,Tags=[{'Key':'Name','Value':'private_subnet_1'}])
ec2_client.create_tags(Resources=subnet_4_private_tag,Tags=[{'Key':'Name','Value':'private_subnet_2'}])
...
bastion_sec_group = ec2.create_security_group(
    ...
    Description='allowing ssh to bastion',
    VpcId=vpc.id
)
...
sec_group = ec2.create_security_group(
    ...
    Description='allowing ssh http access',
    VpcId=vpc.id
)
